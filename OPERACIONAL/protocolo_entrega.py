"""
=============================================================================
  PROTOCOLO DE ENTREGA E RECEBIMENTO DE DOCUMENTOS - ALVES CARNEIRO ADVOCACIA E CONSULTORIA JURÍDICA
=============================================================================
...
# ============================================================
ESCRITORIO = {
    'nome': os.getenv('ESCRITORIO_NOME', 'ALVES CARNEIRO ADVOCACIA E CONSULTORIA JURÍDICA'),
    'advogada': os.getenv('ESCRITORIO_ADVOGADO', 'Dra. Fabiana Silva Alves Carneiro'),
    'oab': os.getenv('ESCRITORIO_OAB', 'OAB/RJ 188.762'),
    'endereco': os.getenv('ESCRITORIO_CIDADE', 'Rio de Janeiro/RJ'),
}
...
def executar_protocolo(args):
    ...
    print('\n' + '=' * 70)
    print('  PROTOCOLO DE ENTREGA/RECEBIMENTO - ALVES CARNEIRO ADVOCACIA E CONSULTORIA JURÍDICA')
    print('=' * 70)
...
def main():
    parser = argparse.ArgumentParser(
        description='Protocolo de Entrega/Recebimento de Documentos - Alves Carneiro Advocacia e Consultoria Jurídica'
    )
