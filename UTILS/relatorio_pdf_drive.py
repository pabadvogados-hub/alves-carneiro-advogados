...
Alves Carneiro Advocacia e Consultoria Jurídica.
...
def _selftest():
    ...
    with open(html, 'w', encoding='utf-8') as fh:
        fh.write('<!doctype html><meta charset=utf-8>'
                 '<h1 style="font-family:sans-serif;color:#b8923f">ALVES_CARNEIRO_ADVOGADOS selftest</h1>'
...
def main():
    ap = argparse.ArgumentParser(description='HTML -> PDF -> Google Drive (ALVES_CARNEIRO_ADVOGADOS)')
