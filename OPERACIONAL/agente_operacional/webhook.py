...
N8N monitora tarefas ADVBOX atribuidas ao usuario-agente (CARNEIRO.IA) e dispara:
...
app = FastAPI(title='Agente Operacional ALVES_CARNEIRO_ADVOGADOS', version='1.0')
...
@app.get('/healthcheck')
def healthcheck():
    return {'status': 'ok', 'servico': 'agente_operacional_carneiro_advogados'}
