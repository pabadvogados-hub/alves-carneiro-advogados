"""Constantes e configuracao do Agente Operacional - Alves Carneiro Advocacia e Consultoria Jurídica.
...
# ADVBOX
# ============================================================
# ID do usuario-agente (CARNEIRO.IA) no ADVBOX - a conta a quem as tarefas sao atribuidas.
...
# referenciando a tarefa original (ex: "[CARNEIROIA-FEITO #12345]"), NAO refaz o trabalho.
...
MARCADOR_CONCLUSAO = 'CARNEIROIA-FEITO'
...
# Assinatura padrao das pecas geradas (previdenciario - Dra. Fabiana).
