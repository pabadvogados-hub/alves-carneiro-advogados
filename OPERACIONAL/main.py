"""
=============================================================================
  SQUAD OPERACIONAL - ALVES CARNEIRO ADVOCACIA E CONSULTORIA JURÍDICA
=============================================================================
  ...
  Uso:
    cd "AUTOMACOES ALVES_CARNEIRO_ADVOGADOS" && python OPERACIONAL/main.py tarefas
    cd "AUTOMACOES ALVES_CARNEIRO_ADVOGADOS" && python OPERACIONAL/main.py processos
    cd "AUTOMACOES ALVES_CARNEIRO_ADVOGADOS" && python OPERACIONAL/main.py prazos
    cd "AUTOMACOES ALVES_CARNEIRO_ADVOGADOS" && python OPERACIONAL/main.py gerar-peca <lawsuit_id>
    cd "AUTOMACOES ALVES_CARNEIRO_ADVOGADOS" && python OPERACIONAL/main.py gerar-peticao "C:\\pasta_do_cliente"
...
def _headers():
    ...
    return {
        ...
        'User-Agent': 'ALVES_CARNEIRO_ADVOGADOS-Advocacia/1.0',
    }
...
def cmd_tarefas(args):
    print('=' * 80)
    print('  TAREFAS PENDENTES - ALVES CARNEIRO ADVOCACIA E CONSULTORIA JURÍDICA')
    print('=' * 80)
...
def cmd_processos(args):
    print('=' * 80)
    print('  PROCESSOS ATIVOS - ALVES CARNEIRO ADVOCACIA E CONSULTORIA JURÍDICA')
    print('=' * 80)
...
def main():
    parser = argparse.ArgumentParser(description='Squad Operacional - Alves Carneiro Advocacia e Consultoria Jurídica')
