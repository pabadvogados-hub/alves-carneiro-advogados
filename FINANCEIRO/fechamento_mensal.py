"""
=============================================================================
  FECHAMENTO MENSAL COMPLETO - ALVES CARNEIRO ADVOCACIA E CONSULTORIA JURÍDICA
=============================================================================
...
def banner(nome_mes, ano, start_date, end_date):
    print('\n')
    print('=' * 70)
    print('   ALVES CARNEIRO ADVOCACIA E CONSULTORIA JURÍDICA - FECHAMENTO MENSAL COMPLETO')
...
def main():
    parser = argparse.ArgumentParser(description='Fechamento Mensal Completo - Alves Carneiro Advocacia e Consultoria Jurídica')
